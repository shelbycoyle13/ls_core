...
class TestTodoList(unittest.TestCase):
    ...
    def test_all_done(self):
        self.assertFalse(self.todos.mark_all_done())
    ...
    def test_add_invalid(self):
        ...
        with self.assertRaises(TypeError):
            self.todos.add("hi")
        extra_list = TodoList("Other List")
        with self.assertRaises(TypeError):
            self.todos.add(extra_list)
    ...
    def test_str_done_todo(self):
        ...
        self.assertTrue(string, str(self.todos))
    ...
    def test_each(self):
        new_list = []
        self.todos.each(lambda todo: new_list.append(todo))
